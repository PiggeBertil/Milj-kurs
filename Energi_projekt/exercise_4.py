...
eta = {'Wind' : 1, 'PV' : 1, 'Gas' : 0.4, 'Hydro' : 1, 'Battery' : 0.9, 'Nuclear': 1} #you could also formulate eta as a time series with the capacity factors for PV and wind
...
if __name__ == '__main__':
    ...
    plt.savefig("4_transmision_capacities.png", dpi = 300)
    ...
    plt.savefig("4_transmision.png", dpi = 300)
